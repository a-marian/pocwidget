...
<html>
	...
	<body>
		<a href="#edit-widget" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
	
		<div id="edit-widget" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:widgetInstance, action:'updateYoutube']" method="PUT" >
				<g:hiddenField name="version" value="${widgetInstance?.version}" />
				<fieldset class="form">
	...
	<g:textField name="videoId" pattern="${widgetInstance.constraints.videoId.matches}" value="${widgetInstance?.videoId}"/>
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="updateYoutube" value="${message(code: 'default.button.update.label', default: 'Update')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
