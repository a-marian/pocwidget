...
<html>
	<head>
		<meta name="layout" content="mainFrontend">
                <link rel="stylesheet" href="../css/templates/${templateInstance.name}.css" type="text/css">
		...
		<div class="page">
			...
			<div class="body home">
				...
				<div class="featured">
                                        ...
                                        <g:if test=" ${videoWidget != null || videoWidget.platform.equals('Youtube')} " >
                                             <youtube:video height="${videoWidget.height}" width="${videoWidget.width}" id="${videoWidget.videoId}"/>
					</g:if>
                                        <g:elseif test=" ${videoWidget != null || videoWidget.platform.equals('Vimeo')} " >
                                            <vimeo:video height="${videoWidget.height}" width="${videoWidget.width}" id="${videoWidget.videoId}"/>
                                        </g:elseif>
                                        <g:else>
